...
public class TestItemCounter {
    ...
    public static void main(String[] args) {
        ...
        // Init Comparators
        Comparator sortByCount = new SortShirtByCount();
        Comparator sortByDesc = new SortShirtByDesc();

        // Print Results - Sort by Description
        Collections.sort(poloList,sortByDesc);
        ...
        Collections.sort(poloList,sortByCount);
